export default function VehicleDetail(prop){
    console.log(prop);
            ...
            <div className={`${prop.dark ? "bg-navy-blue" : "bg-white"} text-white rounded-xl mt-6 flex shadow-2xl`}>
                <div className="my-8 mr-4 w-full">
                    <div className="flex flex-col mr-3 lg:flex-row lg:items-baseline lg:justify-between">
                        <div className="p-5">
                            <p className={`${prop.dark ? "text-white" : "text-dark-navy-blue-2"} font-bold text-lg 480:text-2xl -mb-2 480:mb-1`}>Vehicle Specification</p>
                        </div>
                    </div>
                    <div className="mt-6 480:mt-10 -ml-20 pl-5 text-xs 480:text-base lg:ml-0 lg:mt-3">
                        <div className={`flex mr-4 justify-around mt-8 480:-ml-12 rounded-xl py-4 lg:ml-0 ${prop.dark ? "bg-dark-navy-blue" : "bg-whitish-blue"}`}>
                            <div className="flex flex-col">
                                <p className={`${prop.dark ? "text-white" : "text-gray"}`}><span className="text-red">VIN:</span> {prop.vehicle?.specification.vin}</p>
                                <p className={`${prop.dark ? "text-white" : "text-gray"}`}><span className="text-red">Make:</span> {prop.vehicle?.specification.make}</p>
                                <p className={`${prop.dark ? "text-white" : "text-gray"}`}><span className="text-red">Model:</span> {prop.vehicle?.specification.model}</p>
                                <p className={`${prop.dark ? "text-white" : "text-gray"}`}><span className="text-red">Year:</span> {prop.vehicle?.specification.year}</p>
                                <p className={`${prop.dark ? "text-white" : "text-gray"}`}><span className="text-red">Style:</span> {prop.vehicle?.specification.style}</p>
                                <p className={`${prop.dark ? "text-white" : "text-gray"}`}><span className="text-red">Engine:</span> {prop.vehicle?.specification.engine}</p>
                                <p className={`${prop.dark ? "text-white" : "text-gray"}`}><span className="text-red">Made in:</span> {prop.vehicle?.specification.made_in}</p>
                                <p className={`${prop.dark ? "text-white" : "text-gray"}`}><span className="text-red">Tank Size:</span> {prop.vehicle?.specification.tank_size}</p>
                                <p className={`${prop.dark ? "text-white" : "text-gray"}`}><span className="text-red">Trim Level:</span> {prop.vehicle?.specification.trim_level}</p>
                                <p className={`${prop.dark ? "text-white" : "text-gray"}`}><span className="text-red">City Mileage:</span> {prop.vehicle?.specification.city_mileage}</p>
                                <p className={`${prop.dark ? "text-white" : "text-gray"}`}><span className="text-red">Over all:</span> {prop.vehicle?.specification.overall_width}</p>
                                <p className={`${prop.dark ? "text-white" : "text-gray"}`}><span className="text-red">Steering Type:</span> {prop.vehicle?.specification.steering_type}</p>
                                <p className={`${prop.dark ? "text-white" : "text-gray"}`}><span className="text-red">Over all length:</span> {prop.vehicle?.specification.overall_length}</p>
                                <p className={`${prop.dark ? "text-white" : "text-gray"}`}><span className="text-red">Highway Mileage:</span> {prop.vehicle?.specification.highway_mileage}</p>
                                <p className={`${prop.dark ? "text-white" : "text-gray"}`}><span className="text-red">Standard Seating:</span> {prop.vehicle?.specification.standard_seating}</p>
                                <p className={`${prop.dark ? "text-white" : "text-gray"}`}><span className="text-red">Anti Brake System:</span> {prop.vehicle?.specification.anti_brake_system}</p>
